...
namespace Client3
{
    ...
    public class IClient3Proxy_Implementation : Immortal.InstanceProxy, IClient3Proxy
    {
        ...
        async Task
        ResponseFromServerAsync(System.Int32 p_0)
        {
...
arg0Size = IntSize(arg0Bytes.Length) + arg0Bytes.Length;
            ...
            var wp = this.StartRPC<object>(methodIdentifier: 1 /* method identifier for ResponseFromServer */, lengthOfSerializedArguments: totalArgSize, taskToWaitFor: out rpcTask);
...
wp.curLength += arg0Bytes.Length;
        ...
        void IClient3Proxy.ResponseFromServerFork(System.Int32 p_0)
        {
            SerializableTaskCompletionSource rpcTask;
...
arg0Size = IntSize(arg0Bytes.Length) + arg0Bytes.Length;
            ...
            var wp = this.StartRPC<object>(1 /* method identifier for ResponseFromServer */, totalArgSize, out rpcTask, RpcTypes.RpcType.FireAndForget);
...
wp.curLength += arg0Bytes.Length;
        ...
        private object
        ResponseFromServer_ReturnValue(byte[] buffer, int cursor)
        {
            // buffer will be an empty byte array since the method ResponseFromServer returns void
