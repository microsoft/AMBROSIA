...
Write-Host "Executing codegen command: $AMBROSIATOOLS\$AMBVARIANT\AmbrosiaCS.exe CodeGen -a=DashboardAPI\bin\$AMBVARIANT\DashboardAPI.dll -p=DashboardAPI\DashboardAPI.csproj -o=DashboardAPIGenerated -f=net461"
& $AMBROSIATOOLS\$AMBVARIANT\AmbrosiaCS.exe CodeGen -a="DashboardAPI\bin\$AMBVARIANT\DashboardAPI.dll" -p="DashboardAPI\DashboardAPI.csproj" -o="DashboardAPIGenerated" -f="net461"
...
& $AMBROSIATOOLS\$AMBVARIANT\AmbrosiaCS.exe CodeGen -a="DashboardAPI\bin\$AMBVARIANT\DashboardAPI.dll" -a="AnalyticsAPI\bin\$AMBVARIANT\AnalyticsAPI.dll" -p="DashboardAPI\DashboardAPI.csproj" -p="AnalyticsAPI\AnalyticsAPI.csproj" -o="AnalyticsAPIGenerated" -f="net461"