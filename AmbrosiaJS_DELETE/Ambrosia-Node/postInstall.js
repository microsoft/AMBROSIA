...
// It copies the "sample" ambrosiaConfig.json file [but ONLY if it doesn't already exist] - and its schema [which is always copied] - to the
// installation folder (ie. the folder where 'npm install' was run from). This package.json technique ("postinstall": "node postInstall.js")
...
if (process.env.INIT_CWD)
{
    ...
    if (sourceFolder !== destinationFolder)
    {
        try
        {
            ...
            console.log("ATTENTION: You must edit the ambrosiaConfig.json file to match your Ambrosia instance registration.");
            console.log("           See 'RegisterInstance' in https://github.com/microsoft/AMBROSIA/tree/master/Samples/HelloWorld for more details.");
