...
// Note: This file was generated on 2020/11/09 at 12:16:56.539.
...
import * as PTM from "./PI"; // PTM = "Published Types and Methods"
                ...
                switch (rpc.methodID)
                {
                    case IC.POST_METHOD_ID:
                        try
                        {
                            ...
                            {
                                case "ComputePI":
                                    let digits: PTM.Published.PI.Digits = IC.getPostMethodArg(rpc, "digits?");
            ...
            case Messages.DispatchedMessageType.AppEvent:
                ...
                switch (appEvent.eventType)
                {
                    case Messages.AppEventType.ICStarting:
                        ...
                        // TODO: Add an exported function 'onICStarting(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;

                    case Messages.AppEventType.ICStarted:
                        // TODO: Add an exported function 'onICStarted(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;

                    case Messages.AppEventType.ICStopped:
                        // TODO: Add an exported function 'onICStopped(exitCode: number): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;

                    case Messages.AppEventType.ICReadyForSelfCallRpc:
                        // TODO: Add an exported function 'onICReadyForSelfCallRpc(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;
    
                    case Messages.AppEventType.RecoveryComplete:
                        await PTM.AppEventHandlers.onRecoveryComplete();
                        break;

                    case Messages.AppEventType.UpgradeStateAndCode:
                        // TODO: Add an exported [non-async] function 'onUpgradeStateAndCode(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;

                    case Messages.AppEventType.IncomingCheckpointStreamSize:
                        // TODO: Add an exported function 'onIncomingCheckpointStreamSize(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;
                    
                    case Messages.AppEventType.FirstStart:
                        // TODO: Add an exported function 'onFirstStart(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;

                    case Messages.AppEventType.BecomingPrimary:
                        // TODO: Add an exported function 'onBecomingPrimary(): void' to PI.ts then (after the next code-gen) a call to it will be generated here
                        break;
                }
                break;
        }
