...
dotnet publish -o /ambrosia/ambrosia/bin/x64/Release/netcoreapp3.1 -c %BuildConfig% -f netcoreapp3.1 -r win10-x64 Clients/CSharp/AmbrosiaLibCS/AmbrosiaLibCS.csproj
