...
dotnet publish -o /ambrosia/ambrosia/bin/x64/Release/netcoreapp2.0 -c Release -f netcoreapp2.0 -r win10-x64 DevTools/UnsafeDeregisterInstance/UnsafeDeregisterInstance.csproj
