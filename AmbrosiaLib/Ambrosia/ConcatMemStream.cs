    ...
    class ConcatMemStream : Stream
    {
        ...
        public void AddSource(byte [] newSource)
        {
            if (newSource.Length > 0)
            {
                ...
                _sourceLengths.Add(newSource.Length);
            }
        ...
        public void StartPump()
        {
            ...
            _lengthIterator = _sourceLengths.GetEnumerator();
            _lengthIterator.MoveNext();
        } 
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            long bytesLeftInCurrentArray = _lengthIterator.Current - _sourceIterator.Current.Position;
