...
{
    /// <summary>
    /// This class runs in the process of the object that implements the interface ICommandShellImmortal
    ...
    /// that supports the interface ICommandShellImmortal.
    /// </summary>
    class ICommandShellImmortal_Dispatcher_Implementation : Immortal.Dispatcher
    {
        private readonly ICommandShellImmortal instance;
		private readonly ExceptionSerializer exceptionSerializer = new ExceptionSerializer(new List<Type>());

        public ICommandShellImmortal_Dispatcher_Implementation(Immortal z, ImmortalSerializerBase myImmortalSerializer, string serviceName, int receivePort, int sendPort, bool setupConnections)
            : base(z, myImmortalSerializer, serviceName, receivePort, sendPort, setupConnections)
        {
            this.instance = (ICommandShellImmortal) z;
        }

        public  ICommandShellImmortal_Dispatcher_Implementation(Immortal z, ImmortalSerializerBase myImmortalSerializer, string localAmbrosiaRuntime, Type newInterface, Type newImmortalType, int receivePort, int sendPort)
